...
class ImportDoRequestDetails extends StatefulWidget {
  const ImportDoRequestDetails({Key? key}) : super(key: key);

  @override
  _ImportDoRequestDetailsState createState() => _ImportDoRequestDetailsState();
}

class _ImportDoRequestDetailsState extends State<ImportDoRequestDetails> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: generateAppBar(context, "DO Request Details"),
        ...
        Expanded(
          child: Padding(
            ...
            child: ListView(children: [
              ...
              SizedBox(height: 10),
              doBlOtherDetails(context),
              SizedBox(height: 10),
              doVesselDetails(context),
              SizedBox(height: 10),
          ...
          children: [
            ...
            Row(mainAxisAlignment: MainAxisAlignment.start, children: [
              Column(
                  ...
                  crossAxisAlignment: CrossAxisAlignment.start,
                  children: [
                    labelHeaderText(context, 'DO Requester'),
                    SizedBox(
                      width: MediaQuery.of(context).size.width /
                          2.5, // hard coding child width
                      child: labelText(context, "Manish G"),
                    ),
              ...
              Column(
                  ...
                  crossAxisAlignment: CrossAxisAlignment.start,
                  children: [
                    labelHeaderText(context, 'DO Request Date'),
                    SizedBox(
                      width: MediaQuery.of(context).size.width /
                          2.5, // hard coding child width
            ...
            Row(
                ...
                children: [
                  Column(
                      ...
                      crossAxisAlignment: CrossAxisAlignment.start,
                      children: [
                        labelHeaderText(context, 'Cargo Type'),
                        SizedBox(
                          width: MediaQuery.of(context).size.width /
                              2.5, // hard coding child width
                          child: labelText(context, "GEN"),
                        ),
                        // labelText(context, lblSlot),
                      ]),
                  Column(
            ...
            Column(
                ...
                children: [
                  ...
                  labelText(
                      context, "SBB FOODS, LLC 15681 35TH ST. SE CASSELTON, N"),
                  // SizedBox(
                  //   width: MediaQuery.of(context).size.width /
                  //       2, // hard coding child width
                  //   child: labelText(
