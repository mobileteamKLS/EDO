...
import 'imp_trackandtracedetails.dart';

class ImportTrackTraceList extends StatelessWidget {
  const ImportTrackTraceList({Key? key}) : super(key: key);

  @override
  Widget build(BuildContext context) {
    return Scaffold(
      backgroundColor: Color(0xFFF4F7FB),
      appBar: generateAppBar(context, "Track and Trace List"),
      body: Column(
        children: [
          SizedBox(height: 10),
